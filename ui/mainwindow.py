...
"border-color: rgb(0, 0, 0);")
        ...
        self.maxVote = QtWidgets.QLineEdit(self.centralwidget)
        self.maxVote.setEnabled(True)
        self.maxVote.setMaximumSize(QtCore.QSize(100, 16777215))
        self.maxVote.setStyleSheet("background-color: rgb(220, 220, 220);\n"
"border-color: rgb(0, 0, 0);")
        self.maxVote.setReadOnly(True)
        self.maxVote.setObjectName("maxVote")
        self.horizontalLayout_2.addWidget(self.maxVote)
...
"color: rgb(255, 0, 0);")
        ...
        self.menuInformazioni.addAction(self.display)
        self.menuInformazioni.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_16.setText(_translate("MainWindow", "Voto massimo"))
...
"con crediti"))
        self.label_15.setText(_translate("MainWindow", "Automazione voti\n"
"per giudici esaminatori."))
        self.menuGare.setTitle(_translate("MainWindow", "Files"))
        self.menuGara.setTitle(_translate("MainWindow", "Esame"))
        self.menuInformazioni.setTitle(_translate("MainWindow", "Impostazioni"))
